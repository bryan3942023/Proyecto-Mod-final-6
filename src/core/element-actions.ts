...
export class ElementActions {
    ...
    static async locatorCount(locator: string){
        return driverInstance.Page.locator(locator).count();
    }
    ...
    static async screenshot(){
         ...
         await driverInstance.Page.screenshot({ path: './captures/screenshot.png', fullPage: true });
    }
